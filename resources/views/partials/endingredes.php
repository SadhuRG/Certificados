...
<div class="bg-[#EBF1FD]">
    <div class="pt-10 mt-5">
        ...
        <div class="mb-8 rounded-lg flex items-center justify-center">
            <a href="{{ route('horario') }}" class="ml-1 mr-2 px-5 py-3 flex items-center justify-center bg-[#9636AD] bg-[#9636AD] hover:bg-[#3454A1] font-semibold rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 border-[#9636AD] hover:border-[#3454A1] border-2 lg:ml-2">
